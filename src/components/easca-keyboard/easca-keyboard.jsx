...
import './easca-keyboard.css';
export class Easca extends React.Component {
	constructor() {
	  super();
	  this.state = {};
	}
			...
			<div>
			  ...
			  <div id="keyboard-container">
				...
				<div className="btn-group btn-group-lg" id="shift-line" role="group" aria-label="...">					
				  ...
				  <button type="button" id="copy" data-clipboard-target="#output" className="btn-right btn btn-outline-dark">
			  ...
			  <div >
				<div className="btn-group btn-group-lg" id="j-line" role="group" aria-label="...">
				  {/* 								
										  ...
										  <button type="button" class="btn-left-logo btn btn-outline-dark">a</button>
										  <button type="button" class="btn-right-logo btn btn-outline-dark">s</button>
										  <button type="button" class="btn-left-logo btn btn-outline-dark">c</button>	
										  <button type="button" class="btn-right-logo btn btn-outline-dark">a</button> */}
				</div>
			  </div>
			</div>
		  );
